...
const CoinDetails = () => {
  ...
  return (
    <Container maxWidth={"container.xl"} bgColor={"blackAlpha.800"} color={"white"}>
      {
        loading ? <Loader /> : (
          <>

            <Box borderWidth={0} width={"full"}>
...
const CustomBar = ({ high, low }) => (
  <VStack w={"full"}>
    <Progress value={Math.floor(Math.random()*100)} colorScheme={"telegram"} w={"full"} />    {/* sorry for false data */}
